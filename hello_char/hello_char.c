...
static int major;
static const char *msg = "Hello Kernel Hacker! \n";
...
int init_module(void){
	...
	printk(KERN_INFO ">>> I was assinged major number %d. <<<\n", major);
...
/*
 * Called when a process, which is already opened the dev file, attempts to
 * read from it.
 */
